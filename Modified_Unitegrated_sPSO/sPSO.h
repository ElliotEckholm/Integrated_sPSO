...
#define R_max 10000		// Max number of runs
...
# define randNbMax 2*DMax * S_max // // When using a list of previously generated random numbers
											// Suggestion: 2*DMax * S_max

#define ERROR(a) {printf("\nERROR: %s\n", a);exit(-1);}

//Pointer to fitness function
typedef double (*ptrfunction)(gsl_vector *, void *);
